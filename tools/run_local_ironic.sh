...
IRONIC_IMAGE=${IRONIC_IMAGE:-"quay.io/shwetachavan/ironic-image-1:master"}
IRONIC_INSPECTOR_IMAGE=${IRONIC_INSPECTOR_IMAGE:-"quay.io/shwetachavan/ironic-image-1"}
...
HTTP_PORT="6180"
PROVISIONING_IP="${PROVISIONING_IP:-${CLUSTER_URL_HOST}}"
CLUSTER_PROVISIONING_IP="${CLUSTER_PROVISIONING_IP:-${CLUSTER_URL_HOST}}"
PROVISIONING_INTERFACE="${PROVISIONING_INTERFACE:-"ironicendpoint"}"
CLUSTER_DHCP_RANGE="${CLUSTER_DHCP_RANGE:-${CLUSTER_DHCP_RANGE}}"
